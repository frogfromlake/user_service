...
var file_user_svc_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x1a, 0x1a, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x72, 0x70, 0x63, 0x5f, 0x63, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x19,
	0x75, 0x73, 0x65, 0x72, 0x2f, 0x72, 0x70, 0x63, 0x5f, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x5f, 0x75,
	0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xc5, 0x01, 0x0a, 0x15, 0x55, 0x73,
...
var file_user_svc_proto_goTypes = []interface{}{
	...
	(*user.LoginUserRequest)(nil),   // 1: pb.LoginUserRequest
	(*user.CreateUserResponse)(nil), // 2: pb.CreateUserResponse
	(*user.LoginUserResponse)(nil),  // 3: pb.LoginUserResponse
}
var file_user_svc_proto_depIdxs = []int32{
	0, // 0: pb.UserManagementService.CreateUser:input_type -> pb.CreateUserRequest
	1, // 1: pb.UserManagementService.LoginUser:input_type -> pb.LoginUserRequest
	2, // 2: pb.UserManagementService.CreateUser:output_type -> pb.CreateUserResponse
	3, // 3: pb.UserManagementService.LoginUser:output_type -> pb.LoginUserResponse
