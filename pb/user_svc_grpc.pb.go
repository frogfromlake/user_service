...
func (c *userServiceClient) LoginUser(ctx context.Context, in *user.LoginUserRequest, opts ...grpc.CallOption) (*user.LoginUserResponse, error) {
...
func (UnimplementedUserServiceServer) LoginUser(context.Context, *user.LoginUserRequest) (*user.LoginUserResponse, error) {
...
func _UserService_LoginUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).LoginUser(ctx, req.(*user.LoginUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
